...
export class CatalogComponent implements OnInit {
  ...
  ngOnInit(): void {
    const hasPage = this.activatedRoute.snapshot.queryParamMap.has('page');
    if (!hasPage) {
      this.router.navigate([], {
        relativeTo: this.activatedRoute, queryParams: { page: 1 },
  ...
  processCatalog() {
    this.categoryService.getCategoriesWidthTypes()
      .subscribe(data => {
  ...
  toggleFiltration() {
    this.filtrationOpen = !this.filtrationOpen;
  }
